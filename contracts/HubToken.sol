...
/**
 * @dev HubToken can expand just though hold
 */

contract HUBToken is Context, IERC20, Ownable {
    ...
    address public burnWallet = 0x000000000000000000000000000000000000dEaD;//销毁的地址
    ...
    uint256 public _maxTxAmount = 1_000_000_000_000_000 * DECIMAL;
